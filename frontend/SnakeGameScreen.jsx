...
const SNAKE_GAME_PATH = '/snake_game.html'; // Assurez-vous que ce chemin est correct

/**
 * Composant Modale pour afficher le jeu Snake dans une iframe.
 */
const SnakeGameScreen = ({ showSnake, setShowSnake, simulateTerminalCloseHistory }) => {
